...
<!--建筑参数-->
		...
		<div class="tda checkbox" >
			<span class="tsp">适合行业：</span>
			<div class="l font_lh checkbox " >  
			<label  for="dz"><input type="checkbox" value="" id='dz'/>电子</label> 
			<label  for="yy"><input type="checkbox" value="" id='yy'/>医药</label> 
			<label for="dz"><input type="checkbox" value="" id='dz'/>电子</label> 
			<label for="dz"><input type="checkbox" value="" id='dz'/>电子</label> 
			<label for="dz"><input type="checkbox" value="" id='dz'/>电子</label> 
			<label for="dz"><input type="checkbox" value="" id='dz'/>电子</label> 		 												
