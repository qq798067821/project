	...
	<div class="pi">
		...
		<div class="tr">
			<div class="td"> 
				...
				<img class="m_id_img" src="" id='m_id_img_z'/> 
			</div>
			<div class="td">
				 <span class="tsp">&nbsp;</span>
...
<script type="text/javascript">
	$(function(){
		$('.m_id_t a').eq(0).css({'border-bottom': '2px solid #00AE66',"color":'#394043'});
		$('.m_id_t  a').click(function(e){
			var m_id_mun=$(this).index();
			$(this).css({'border-bottom': '2px solid #00AE66',"color":'#394043'}).siblings().css({'border-bottom': 'none',"color":'#666'});
